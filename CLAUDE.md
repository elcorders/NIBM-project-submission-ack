...
Students enter their submission token (from index.html) to verify identity, then pick a viva day (Sat 10 May or Sun 11 May 2026) and an hour-long time window. Slots have a capacity of 5 students each, with lab-computer users blocked from evening slots (7pm–11pm on Sundays).
